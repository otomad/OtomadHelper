			...
			<svg width={ICON_INITIAL_SIZE} height={ICON_INITIAL_SIZE} viewBox={`0 0 ${ICON_INITIAL_SIZE} ${ICON_INITIAL_SIZE}`} xmlns="http://www.w3.org/2000/svg">
				<mask id={maskId}>
					...
					<g
						...
						strokeWidth={1}
					>
						<path stroke="black" d="M1.21 -0.21L16.21 14.79" strokeWidth={1.5} />
						<path stroke="white" d="M0.5 0.5L15.5 15.5" />
						<animate
							fill="freeze" attributeName="stroke-dashoffset" dur="250ms" values={`${STROKE_DASHARRAY}; 0`} calcMode="spline"
