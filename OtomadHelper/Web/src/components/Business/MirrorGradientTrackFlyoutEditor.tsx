...
const ParityPatterns = Enum({
	...
	evenColumns: { label: undefined!, icon: "parity/even_columns" },
	oddColumns: { label: undefined!, icon: "parity/odd_columns" },
	evenRows: { label: undefined!, icon: "parity/even_rows" },
	oddRows: { label: undefined!, icon: "parity/odd_rows" },
	evenChecker: { label: undefined!, icon: "parity/even_checker" },
	oddChecker: { label: undefined!, icon: "parity/odd_checker" },
	evenDots: { label: undefined!, icon: "parity/even_dots" },
	oddDots: { label: undefined!, icon: "parity/odd_dots" },
	evenGridlines: { label: undefined!, icon: "parity/even_gridlines" },
	oddGridlines: { label: undefined!, icon: "parity/odd_gridlines" },
