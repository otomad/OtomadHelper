const eases = {
	...
	// #region 缓出缓入
	// 缓入缓出的逆向运动曲线。由于部分缓入缓出的曲线表现为开始快结束慢，因此此处为它们的逆运算，即开始慢结束快。
	/**
	 * ### 缓动
	 * 以慢速开始，然后变快，然后慢速结束的过渡效果。\
	 * 此为 `ease` 的逆向运动。
	 */
	easeOutIn: "cubic-bezier(0.75, 0, 0.75, 0.9)",
	/**
	 * ### 流利设计点对点缓出缓入
	 * 微软 Windows 11 Fluent 2 中用于点对点的缓动，如窗口最大化、还原等。
	 */
	easeOutInFluent: "cubic-bezier(1, 0, 0.45, 1)",
	/**
	 * ### 质感设计强调缓出缓入
	 * 谷歌 Material Design 3 强调缓动，它捕捉了 Material Design 3 的表现风格。
	 */
	easeOutInMaterialEmphasized: "linear(0, 0.002 13.6%, 0.009 25.6%, 0.021 36.0%, 0.037 45.0%, 0.058 52.8%, 0.084 59.4%, 0.117 64.9%, 0.155 69.6%, 0.192 72.7%, 0.235 75.4%, 0.283 77.6%, 0.34 79.4%, 0.456, 0.656 83.9%, 0.729 85.0%, 0.806 86.6%, 0.872 88.6%, 0.926 90.9%, 0.966, 0.99 96.4%, 0.998, 1)",
	/**
	 * ### 质感设计标准缓出缓入
	 * 谷歌 Material Design 3 标准缓动，用于简单、小型或以实用性为中心的过渡。
	 */
	easeOutInMaterialStandard: "cubic-bezier(1, 0, 0.8, 1)",
	// #endregion
};
