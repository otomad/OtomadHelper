...
const SChinese = {
	translation: {
		...
		selectInfo: {
			...
			trackEvent: "已选中{{count}}个轨道剪辑。",
			videoEvent: "已选中{{count}}个视频轨道剪辑。",
			audioEvent: "已选中{{count}}个音频轨道剪辑。",
			oneVideoEvent: "必须恰好选择1个视频轨道剪辑，不得多选或少选。",
			oneAudioEvent: "必须恰好选择1个音频轨道剪辑，不得多选或少选。",
		},
		prve: {
			classes: {
				flip: "翻转类",
		...
		descriptions: {
			...
			mosh: {
				...
				datamosh: "快速自动地对视频选中区域进行数据抹失。",
				datamix: "快速自动地对视频选中区域进行数据抹失（将一个剪辑抹入另一个剪辑）。",
				layer: "快速自动地对选中剪辑进行多层叠化。",
				render: "快速自动地对视频选中区域进行渲染。",
				scramble: "快速自动地对选中剪辑进行打乱。",
				automator: "快速自动地为选中视频效果设定随机值。",
				stutter: "口吃剪辑（向前向后播放）。",
				shake: "使用平移/裁切来摇晃选中剪辑。",
			},
			tools: {
				selector: "查找并选中符合指定的条件的所有轨道剪辑。",
				replacer: "将多个轨道剪辑替换为指定的新轨道剪辑。",
				normalizer: "将选中的多个音频轨道剪辑全部规范化音量。",
				subtitles: "预先设定好“字幕和文字”的预设，然后在此添加多行文本。",
				visualizer: "将指定的视频轨道剪辑应用映像节奏视觉效果。",
				fader: "将多个轨道剪辑根据指定的规则来更改增益值。",
				scoreExporter: "依照轨道中的事件来导出乐谱序列文件。",
				flow: "使用贝塞尔曲线创建令人惊叹的动画。",
				converters: {
					tunningMethod: "将多个音频轨道剪辑统一更改为指定的调音算法。",
					timeSignature: "将指定的音乐的节拍在四四拍、四三拍、八六拍等之间进行转换。",
					transformOfx: "将所有平移/裁切关键帧转换成TransformOFX关键帧，以便Miscz插件使用。",
				},
			},
			staff: {
