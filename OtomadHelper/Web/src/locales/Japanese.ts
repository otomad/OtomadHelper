	...
	javascript: {
		...
		descriptions: {
			...
			source: {
				...
				syncopator: {
					...
					mysteryBox: "複数のソースを選択する必要はありません。1つの長いソースを選択するだけです。その後、各クリップのポイントをランダムに選択します。",
				},
				mysteryBox: {
		...
		aliases: {
			...
			source: {
				...
				mysteryBox: "秘密のボックス、ミステリーボックス、ブラインドボックス、ガチャ、ガチャポン、ガチャポン、グラブバッグ、サプライズミー",
			},
			score: {
				tempo: "スピード、BPM",
