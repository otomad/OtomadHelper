	...
	javascript: {
		...
		descriptions: {
			...
			score: {
				...
				encoding: "ファイルを読み込むときに使用するテキストエンコーディングを指定します。文字を入れない限り、この設定を変更しないでください。",
			...
			settings: {
				about: "Omad HelperはVEGAS ProのYTPMV/OTOMAD/YTP拡張機能で、VEGASはMIDIシーケンスファイルなどのスコアを入力として受け入れ、YTPMVトラックを自動生成することができます。",
