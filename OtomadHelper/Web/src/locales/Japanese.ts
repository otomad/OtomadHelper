		...
		stream: {
			...
			tuning: {
				...
				altTuningMethod: {
					...
					multiple: "オーディオ FX プラグインを複数回使用",
					plugin: "Pitch Shift Audio FX プラグインに切り替える",
					octave: "オクターブ下/上昇",
		...
		descriptions: {
			...
			stream: {
				...
				tuning: {
					...
					vocalFry: "ボーカルフライやDubstep 食器洗い機と同様のサウンドを生成するために、粒状振動法でサンプルを1ティック長さに強制します",
					basePitch: {
