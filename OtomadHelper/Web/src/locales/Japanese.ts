	...
	javascript: {
		...
		source: {
			...
			trackGroup: {
				_: "トラックのグループ化",
				ungrouped: "Ungrouped",
				byScoreTrack: "スコアトラックでグループ化",
				byTaskSession: "タスクセッションでグループ化",
				collapse: "トラックグループをデフォルトで閉じる",
				reuseSameName: "同じ名前を持つグループを再利用する",
			},
			naming: {
				_: "名前",
				trackName: "トラックとトラックグループの名前",
				clipName: "クリップの名前",
				unsetBorrowedTrackName: "借りた既存のトラックの名前を変更しない",
				groupByTaskSessionName: "タスク セッションとマルチトラックでグループ化されたときのトラック グループの名前",
		...
		stream: {
			...
			tuning: {
				...
				alternativeForExceedTheRange: {
					...
					octave: "高オクターブ/下オクターブ",
					octaveExp: "高オクターブ/下オクターブ（実験的）",
					dock: "上下にドックする",
					silent: "サイレントモード",
				},
				resample: "リサンプ",
		...
		descriptions: {
			...
			source: {
				...
				naming: {
					_: "生成されたトラック、トラックグループ、およびクリップの名前を指定します",
					unsetBorrowedTrackName: "既存のトラックは「優先トラック」設定によって決定されます。新しく作成されたトラックは影響を受けません。",
					groupByTaskSessionNameTreatSingleAsMultitrack: "トラックグループは、タスクセッションと単一トラックでグループ化された場合、 {{name, lowercase}} を使用します",
				},
				multisource: {
				...
				matchCut: {
					...
					luckyDip: "複数のソースを選択する必要はありません。1つの長いソースを選択するだけです。その後、各クリップのポイントをランダムに選択します。",
				},
				luckyDip: {
		...
		aliases: {
			...
			source: {
				trackGroup: "トラックグループ",
				naming: {
					trackName: "トラック名、トラックグループ名、トラックの名前、トラックグループの名前",
					clipName: "クリップ名、トラックイベント名、トラックイベントの名前",
				},
				luckyDip: "秘密のボックス、ミステリーボックス、ブラインドボックス、ガチャ、ガチャポン、ガチャポン、グラブバッグ、サプライズミー",
			},
			score: {
				tempo: "スピード、BPM",
