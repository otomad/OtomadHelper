	...
	javascript: {
		...
		stream: {
			...
			legato: {
				...
				unlimited: "Unlimited",
				atLeast: "For larger gaps, try to fill them as much as possible",
				atLeast_upToOneBeat: "Do gaps larger than 1 beat still need to be filled to at least 1 beat?",
				atLeast_upToOneBar: "Do gaps larger than 1 bar still need to be filled to at least 1 bar?",
			},
		...
		descriptions: {
			...
			stream: {
				...
				legato: {
					_: "Fills in the gaps between notes",
					atLeast: "When disabled, those large gaps will be ignored and not filled",
				},
			...
			track: {
				...
				grid: {
					...
					dynamicDetection: "Dynamically detects the existence of clips in the active tracks, and automatically changes the number of track boxes. Only one-time processing, without real-time tracking of changes.",
				},
				box3d: {
				...
				legato: {
					...
					stretchKeyframes_off: "Regardless of how the duration changes, the time interval between each keyframe remains unchanged",
