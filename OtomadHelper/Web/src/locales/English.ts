	...
	javascript: {
		...
		stream: {
			...
			legato: {
				...
				unlimited: "Unlimited",
				toMaxGap: "For larger gaps, try to fill them as much as possible",
				toMaxGap_upToOneBeat: "Do gaps larger than 1 beat still need to be filled to 1 beat?",
				toMaxGap_upToOneBar: "Do gaps larger than 1 bar still need to be filled to 1 bar?",
			},
		...
		descriptions: {
			...
			stream: {
				...
				legato: {
					...
					toMaxGap: "When disabled, those large gaps will be ignored and not filled",
				},
