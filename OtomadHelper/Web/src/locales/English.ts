export default {
	javascript: {
		...
		score: {
			...
			constrain: "Constrain note length",
		...
		stream: {
			...
			parameters: {
				...
				constrain: "Constrain keyframes length",
				fade: {
					_: "Fade",
					fadeIn: "Fade in",
					fadeOut: "Fade out",
				...
				plunk: {
					_: "Plunk",
					splicePosition: "Splice position",
					volumeDuck: "Volume duck",
					presets: {
						jario: "Jario Style",
						standard: "Standard",
						snappy: "Snappy",
		...
		descriptions: {
			...
			stream: {
				...
				tuning: {
					...
					vocalFry: "Forces the sample to be 1 tick long in the Granular Oscillator method to produce a sound similar to vocal fry or Dubstep dishwasher",
					basePitch: {
