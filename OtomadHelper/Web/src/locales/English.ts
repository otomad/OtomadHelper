	...
	javascript: {
		...
		stream: {
			...
			legato: {
				...
				atLeast_upToOneBeat: "Do gaps larger than 1 beat still need to be filled to 1 beat?",
				atLeast_upToOneBar: "Do gaps larger than 1 bar still need to be filled to 1 bar?",
			},
