const English = {
	translation: {
		...
		selectInfo: {
			...
			oneVideoEvent: "You must select exactly ONE video event, not more or less.",
			oneAudioEvent: "You must select exactly ONE audio event, not more or less.",
		},
		prve: {
			classes: {
				flip: "Flip Class",
		...
		descriptions: {
			...
			mosh: {
				...
				datamosh: "Datamoshes a part of a video quickly and automatically.",
				datamix: "Datamoshes a part of a video quickly and automatically (mosh a clip onto another).",
				layer: "Does multilayering on a part of a video quickly and automatically.",
				render: "Renders a part of a video quickly and automatically.",
				scramble: "Scrambles clips/events quickly and automatically.",
				automator: "Sets random automation values for video effects quickly and automatically.",
				stutter: "Stutters clips/events (play forward, backward, ...).",
				shake: "Uses Pan/crop to make the selected layers shake.",
			},
			tools: {
				selector: "Find and select all track events that match the specified.",
				replacer: "Replace multiple track clips with specified new track clips.",
				normalizer: "Normalize all selected audio events volume.",
				subtitles: "Preset the \"Titles & Text\" preset, and then add multiple lines of text here.",
				visualizer: "Apply PV rhythm visual effect to the specified video events.",
				fader: "Change the gain value of multiple track clips according to the specified rules.",
				scoreExporter: "Export score sequence files based on the track events.",
				flow: "Create stunning animations using Beziér Curves.",
				converters: {
					tunningMethod: "Change multiple audio events to the specified tuning algorithm.",
					timeSignature: "Convert the specified music beats between 4/4, 3/4, 6/8, etc.",
					transformOfx: "Convert all pan/crop keyframes to TransformOFX keyframes for use by the Miscz plugin.",
				},
			},
			staff: {
