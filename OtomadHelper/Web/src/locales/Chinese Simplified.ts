	...
	javascript: {
		...
		stream: {
			...
			legato: {
				...
				atLeast_upToOneBeat: "大于1拍的间隙仍需填补到至少1拍吗？",
				atLeast_upToOneBar: "大于1小节的间隙仍需填补到至少1小节吗？",
			},
		...
		descriptions: {
			...
			trimIgnored: "如果截止时间小于或等于起始时间，将不会进行修剪。",
			curve: {
			...
			track: {
				...
				legato: {
					...
					stretchKeyframes_off: "无论时长如何变化，各关键帧之间的时间间隔均保持不变",
		...
		aria: {
			...
			previewPiano: {
				...
				instructions: "这是一个模拟钢琴键盘。你可以点击琴键来选择音高。\n选中的琴键将会有视觉反馈。",
			},
