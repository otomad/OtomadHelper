...
namespace Config {
	...
	export const configStore = createStore({
		...
		audio: {
			...
			loop: "false" satisfies TrueFalseAuto as TrueFalseAuto,
		...
		visual: {
			...
			stack: false,
			timeUnremapping: false,
			imitativeResample: "auto" satisfies TrueFalseAuto as TrueFalseAuto,
			imitativeOscillator: "auto" satisfies TrueFalseAuto as TrueFalseAuto,
			transition: false,
