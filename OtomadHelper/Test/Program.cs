...
internal static class Program {
	...
	public static void Main() {
		...
		s = Interop.ColorDisplayNameHelper.ToDisplayName();
#endif
#if TEST6
		_ = QuickSelectInterval1DEditor.ShowDialog([true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false,], 4).Then(r => s = r.Item2.Select(i => i.ToString()).Join(","));
#endif
	}
}
