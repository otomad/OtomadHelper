...
<table>
	<tr>
		<td>Stretch<br />
			...
			拉伸<br />
			ストレッチ</td>
		<td><img src="glossary/stretch.png" alt="Stretch" /></td>
	</tr>
	<tr>
		<td>Loop<br />
			循环<br />
			循環<br />
			ループ</td>
		<td><img src="glossary/loop.png" alt="Loop" /></td>
	</tr>
	<tr>
		<td>No Lengthening<br />
			...
			禁止延長<br />
			延長しない</td>
		<td><img src="glossary/no_lengthening.png" alt="No Lengthening" /></td>
	</tr>
	<tr>
		<td colspan="2"><b><i>Remark:</i></b>
		Alias <b>Freeze Last Frame</b>. After checking, if the trimmed clip selected in the track window is shorter than the MIDI note, it will not be extended. If it is a video clip, it will be frozen at the last frame of the source clip length.</td>
	</tr>
	<tr>
		<td>Create Groups<br />
			创建分组<br />
	...
	<tr>
		<td>Audio - Normalize<br />
			...
			音訊 - 規範化音量<br />
			オーディオ - ノーマライズ</td>
		<td><img src="glossary/normalize.png" alt="Normalize" /></td>
	</tr>
	<tr>
		<td>Video - Static Visual<br />
			...
			視訊 - 靜態畫面<br />
			ビデオ - 静止画像</td>
		<td><img src="glossary/static_visual.png" alt="Static VIsual" /></td>
	</tr>
	<tr>
		<td colspan="2"><b><i>Remark:</i></b>
		Alias <b>Freeze First Frame</b>. After checking, the video will freeze at the first frame.</td>
	</tr>
	<tr>
		<td>Video - Multitrack for Chords<br />
			...
			視訊 - 複音多軌<br />
			ビデオ - 和音の複数トラック</td>
		<td><img src="glossary/multitrack_for_chords.png" alt="Multitrack for Chords" /></td>
	</tr>
</table>
