...
namespace Otomad.VegasScript.OtomadHelper.V4 {
	...
	public class EntryPoint {
		...
		private bool GenerateOtomad() {
			...
			#region 生成五线谱
			if (SheetConfigGenerateStaff && MidiConfigTracks.CurrentChannel == 0) {
	...
	partial class ConfigForm {
		...
		"长末尾。\r\n单位：秒。");
			...
			this.StaffLinesParamsGroup.Location = new System.Drawing.Point(5, 241);
			...
			this.StaffNotesParamsGroup.Size = new System.Drawing.Size(648, 154);
			...
			this.flowLayoutPanel4.Size = new System.Drawing.Size(638, 31);
	...
	public partial class ConfigForm : Form, IConfigIniUser, IInterpret {
		...
		public ConfigForm(EntryPoint entryPoint) {
			...
			#region 检查更新
			/*if (checkUpdateOnStartupToolStripMenuItem.Checked)*/ CheckUpdate(false);
			#endregion
		}
		...
		private void CheckUpdate(bool isManualUpdate) {
			checkUpdateThread = new Thread(() => {
				Lang str = Lang.str;
				bool alertable = isManualUpdate || checkUpdateOnStartupToolStripMenuItem.Checked;
				bool ok, isLatest;
	...
	public class Lang {
		...
		static Lang() {
			...
			English = new Lang {
				...
				sheet_sheet_line_params = "Sheet lines parameters",
			...
			Japanese = new Lang {
				...
				sheet_sheet_line_params = "譜表パラメータ",
			...
			Russian = new Lang {
				...
				sheet_sheet_line_params = "Параметры линий листа",
