...
> #### 这不是脚本本体，这是源代码
>
> 如果你想要下载 Otomad Helper，请点击下面的按钮。
>
> [![Download](https://img.shields.io/badge/-点击下载最新版！-8250df?style=for-the-badge&logo=data:image/svg+xml;base64,)](https://github.com/otomad/OtomadHelper/releases/latest)

> [!NOTE]
>
> #### 请求帮助
>
> 新版本目前正在开发中，需要您的帮助。如果你有时间和技术，请联系我协作完成 Otomad Helper 新版本。
>
> [**预览 Otomad Helper 的下一个大版本 >**](https://github.com/otomad/OtomadHelper/blob/webview/README.next.md)
...
> (例如：C:\\Program Files\\BorisFX\\Vegas Pro 2026\\Script Menu)
...
Vegas Pro 17、18、19、20、21、22、23、2026 测试**正常**。
