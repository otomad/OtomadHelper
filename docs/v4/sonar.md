...
Reference:
[『図形素材』](https://www.youtube.com/watch?v=EbF-O3DpJDE){lang=ja}、[《图形练习》](https://www.bilibili.com/video/BV17f4y1y7sB/){lang=zh-CN}
...
* **Matched Drum Sound**
  * The value of the drum sound used for the generation
    ::: important
    *This should match what the individual drum is in your MIDI*
    :::
* **Shape**
...
::: important
*The center is where the visual will end, this will affect all other parameters*
:::
...
::: important
*These values are the first values to be used for keyframing*
:::
...
::: important
*These values are the additional values to be used for keyframing, which creates interpolation*
:::
