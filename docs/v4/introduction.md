...
@zhs 它也可以用于制作[**YTP**](https://zh.wikipedia.org/wiki/YouTube_Poop)、**声呐效果（动态图形生成功能）**、[**数据抹失（幻术故障、<span lang="zh-TW">資料狂舞</span>）**](https://zh.wikipedia.org/wiki/壓縮失真#藝術上的應用)。
...
@zhs [om midi](https://ommidi.readthedocs.io/) — 适用于After Effects的音MAD辅助脚本。
