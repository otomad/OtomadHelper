...
using static OtomadHelper.Dialogs.PInvoke.ParameterTypes;

namespace OtomadHelper.Dialogs {
	/// <summary>
	...
	public partial class MainWindow : Window {
		...
		private void Window_Loaded(object sender, RoutedEventArgs e) {
			...
			PInvoke.Methods.SetWindowAttribute(Handle,
		...
		private void RefreshFrame() {
			...
			PInvoke.Methods.ExtendFrame(mainWindowSrc.Handle, margins);
		}
